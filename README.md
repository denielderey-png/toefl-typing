...
**内置内容**：约 20,000 个单词（其中 611 个学术核心词含完整 Academic Word List 570 词族 + 原创中文释义；其余为按词频选取的高频真词，作纯打字练习、无释义）、约 230 篇学术短文（29 个主题）、72 道语法题（B1=28 / B2=20 / C1=14 / C2=10）。单词每轮随机打乱出现。配合「每日新闻」的真实材料，练习内容几乎用不完。
